...
namespace Exam\QuickOrder\Setup;
...
class InstallData implements InstallDataInterface
{
    ...
    public function __construct(\Exam\QuickOrder\Model\StatusFactory $postFactory, TransactionFactory $transactionFactory, LoggerInterface $logger)
    {
